    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] via-[#0d1117] to-[#0a0a0f]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          <p className="text-amber-500/50 text-xs tracking-[0.3em] uppercase mb-3">Birth Chart Analysis</p>
          ...
          <p className="text-slate-500 text-base max-w-lg mx-auto">A personalized analysis based on classical Chinese birth chart principles — exploring personality patterns, strengths, and life tendencies for self-reflection.</p>
        </div>
