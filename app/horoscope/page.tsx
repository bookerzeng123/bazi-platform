...
const HOROSCOPE_TEMPLATES: Record<string, {
  ...
  Libra: {
    ...
    health: [
      ...
      "A beauty or self-care practice is nourishment for your spirit today. Don't skip it for productivity — this IS productivity.",
  ...
  Capricorn: {
    ...
    love: [
      ...
      "Attached: Your partner may need more consistency from you than usual. A small promise kept is worth more than a grand gesture forgotten.",
...
"A chronic issue that's been managed deserves a proper check. Don't let 'it's always been this way' be your only diagnostic tool.",
  ...
  Pisces: {
    ...
    career: [
      ...
      "Mindful or reflective practice finds its natural flow today. What you do in this space may help others more than you realize.",
    ],
    money: [
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] via-[#0d1117] to-[#0a0a0f]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-amber-200 to-amber-400 mb-4">Daily Insights</h1>
