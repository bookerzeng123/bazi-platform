    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] via-[#0d1117] to-[#0a0a0f]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-amber-200 to-amber-400 mb-4">I Ching Wisdom</h1>
          ...
          {!hexagram ? (
            <div className="space-y-8">
              <div>
                ...
                />
                <p className="text-slate-700 text-xs mt-2 text-center">I Ching Wisdom responds to all sincere questions — but not all questions have the answer you want to hear.</p>
              </div>
              ...
              >
                {phase === 'tossing' ? 'I Ching Wisdom is Listening...' : 'Cast the Six Coins'}
              </button>
            </div>
          ) : (
